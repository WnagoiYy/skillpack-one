---
name: category-scientific-research
description: Route scientific research requests to focused Atomic Skills; use the localized index to select the smallest capability whose boundary fully covers the requested outcome.
---
...
Includes: literature review; research design; experimental analysis; scholarly manuscripts; citation management. Excludes: generic web research; unsupported medical decisions.

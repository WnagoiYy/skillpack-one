---
name: category-productivity-tools
description: Route productivity tools requests to focused Atomic Skills; use the localized index to select the smallest capability whose boundary fully covers the requested outcome.
---
...
Includes: spreadsheet operation; knowledge vault operation; structured note tools. Excludes: statistical conclusions; personal task prioritization.

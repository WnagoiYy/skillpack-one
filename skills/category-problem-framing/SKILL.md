---
name: category-problem-framing
description: Route problem framing requests to focused Atomic Skills; use the localized index to select the smallest capability whose boundary fully covers the requested outcome.
---
...
Includes: problem statements; scope clarification; assumption mapping. Excludes: generating solution options; executing a domain task.

---
name: category-ideation-planning
description: Route ideation and planning requests to focused Atomic Skills; use the localized index to select the smallest capability whose boundary fully covers the requested outcome.
---
...
Includes: brainstorming; option generation; action plans. Excludes: formal decision scoring; implementation itself.

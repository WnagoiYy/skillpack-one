---
name: category-problem-solving
description: Route problem solving requests to focused Atomic Skills; use the localized index to select the smallest capability whose boundary fully covers the requested outcome.
---
...
Includes: problem framing; brainstorming; general action planning; decision comparison; output critique. Excludes: domain execution that already has a specialized category; source-code implementation.

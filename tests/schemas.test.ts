...
describe("public schemas", () => {
  ...
  it.each([
    ["taxonomy", { schemaVersion: 1, version: "0.1.0", nodes: [{ id: "software-engineering", label: { en: "Software engineering" }, includes: ["software artifacts"], excludes: ["general research"] }] }],

...
describe("public schemas", () => {
  ...
  it.each([
    ...
    ["eval-dataset", { schemaVersion: 1, id: "routing-bootstrap", split: "dev", locale: "en", examples: [{ id: "route-1", prompt: "Evaluate this Skill", expectedCategory: "skill-agent-governance", expectedAtoms: [], expectedSpecial: ["meta-skill-evaluator"], mustNotRoute: [] }] }],

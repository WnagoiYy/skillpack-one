---
name: category-decision-review
description: Route decision and review requests to focused Atomic Skills; use the localized index to select the smallest capability whose boundary fully covers the requested outcome.
---
...
Includes: decision matrices; trade-off analysis; rubric-based critique. Excludes: open-ended ideation; security-specific audits.

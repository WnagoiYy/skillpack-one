---
name: category-developer-tools
description: Route developer tools requests to focused Atomic Skills; use the localized index to select the smallest capability whose boundary fully covers the requested outcome.
---
...
Includes: Git workflows; terminal commands; browser developer workflows. Excludes: writing product code; general office software.
